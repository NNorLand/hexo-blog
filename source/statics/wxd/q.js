var questionJson = [
  {
    ...
    answer: [
      ...
      '中华人民共和国无线电管理办法，工业和信息化部',
      '中华人民共和国电信条例，国务院',
      '中华人民共和国业余无线电台管理办法，工业和信息化部',
    ],
  },
  {
    index: '[I]LK0002',
    ...
    answer: [
      '业余无线电台管理办法，工业和信息化部',
      '个人业余无线电台管理暂行办法，国家体委和国家无委',
      '业余无线电台管理暂行规定，国家体委和国家无委',
      '中华人民共和国电信条例，国务院',
    ],
  },
  {
    ...
    answer: ['各级无线电管理机构', '各级体育管理机构', '各地业余无线电协会', '各地电信管理局'],
  },
  {
    index: '[I]LK0004',
  ...
  },
  {
    index: '[I]LK0104',
    question:
      '无线电频率的使用必须得到各级无线电管理机构的批准，基本依据是“无线电频谱资源属于国家所有”，出自于下列法律的第二百五十二条： ',
    answer: [
      '中华人民共和国民法典',
      '中华人民共和国宪法',
      '中华人民共和国刑法',
  ...
  {
    index: '[I]LK0111',
    question: '无线电业余业务是供业余无线电爱好者作下列用途的无线电通信业务：',
    answer: [
      '自我训练、相互通信和技术研究',
      '救灾抢险、车队联络和技术学习',
      '娱乐休闲、报告路况和公益服务',
  ...
  {
    index: '[I]LK0017',
    question: 'A类业余无线电台允许发射的最大发射功率为不大于：',
    answer: [
      '25瓦',
      '100瓦',
  ...
  {
    index: '[I]LK0026',
    question: '个人申请设置具有发信功能的业余无线电台的年龄条件是：',
    answer: [
      '年满十八周岁',
      '年满十六周岁',
      '年满十四周岁',
  ...
  {
    index: '[I]LK0020',
    question: '负责组织A类和B类业余无线电台所需操作技术能力的验证的机构是：',
    answer: [
  ...
  {
    index: '[I]LK0022',
    question: '2013年1月1日以后新获得的各类业余无线电台操作技术能力证明文件是：',
    answer: [
  ...
  {
    index: '[I]LK0043',
    question: '申请设置和使用业余无线电台的条件所规定的“具备国家规定的操作技术能力”，其标志为：',
    answer: [
  ...
  {
    index: '[I]LK0023',
    question: '个人申请设置业余无线电台应当提交的书面材料为：',
    answer: [
      '两种表格，身份证和操作证书的原件、复印件',
      '三种表格，身份证的原件、复印件',
      '一种表格，身份证和操作证书的原件、复印件',
      '本人写的申请书，身份证和操作证书的原件、复印件',
    ],
  },
  {
    index: '[I]LK0028',
  ...
  {
    index: '[I]LK0029',
    question: '申请设置信标台、空间台和技术参数需要超出管理办法规定的特殊业余电台的办法为：',
    answer: [
  ...
  {
    index: '[I]LK0031',
    question: '设置在省、自治区、直辖市范围内通信的业余无线电台，审批机构为：',
    answer: [
      '设台地的地方无线电管理机构',
      '设台地的地方无线电民间机构',
  ...
  {
    index: '[I]LK0046',
    question: '终止使用业余无线电台的，应当向下列机构申请注销执照：',
    answer: [
      '核发业余无线电台执照的无线电管理机构',
      '国家无线电管理机构',
  ...
  {
    index: '[I]LK0024',
    question: '业余无线电台专用无线电发射设备的重要特征是：',
    answer: [
      '发射频率不得超出业余频段',
      '发射频率必须覆盖所有业余频段',
      '发射方式必须包含调频',
  ...
  {
    index: '[I]LK0038',
    question: '业余无线电台使用的发射设备必须符合下列条件：',
    answer: [
  ...
  {
    index: '[I]LK0039',
    question: '对业余无线电台专用无线电发射设备进行型号核准的依据为：',
    answer: [
      '国家《无线电频率划分规定》中有关无线电发射设备技术指标的规定',
      '地方无线电管理机构制订的技术标准',
      '经国家认证的检测单位所制订的技术标准',
      '国家关于专业无线电通信发射设备的技术标准',
    ],
  },
  {
    index: '[I]LK0040',
    question: '业余无线电台专用无线电发射设备的发射频率必须满足的条件是：',
    answer: [
  ...
  },
  {
    ...
    answer: ['百万分之几（或者赫兹）', 'dB', '瓦', '百分之几（或者兆赫）'],
  },
  {
    index: '[I]LK0118',
  ...
  {
    index: '[I]LK0047',
    question: '业余无线电台使用的频率应当符合下述规定：',
    answer: [
      '《中华人民共和国无线电频率划分规定》',
      'ITU《无线电规则》第IV节“频率划分表”',
      'IARU三区“频率规划”',
      '一般业余无线电书籍所叙述的频率',
    ],
  },
  ...
  {
    index: '[I]LK0140',
    question: '在频率划分表中，一个频带被标明划分给多种业务时，这些业务被分为下述类别：',
    answer: [
      '主要业务和次要业务',
      '业余业务和非业余业务',
      '民用业务和军用业务',
  ...
  },
  {
    ...
    answer: [
      '不得对主要业务电台产生有害干扰',
      '可要求保护不受来自主要业务电台的有害干扰',
      '不得对来自同一业务或其他次要业务电台的有害干扰提出保护要求',
      '容许因设备技术问题对主要业务电台产生短时间有害干扰',
    ],
  },
  {
    index: '[I]LK0142',
  ...
  {
    index: '[I]LK1112',
    question: 'VHF段的频率范围是多少？',
    answer: ['30到300MHz', '30到300kHz', '300到3000kHz', '300到3000MHz'],
  },
  {
    index: '[I]LK1113',
    question: 'UHF段的频率范围是多少？',
    answer: ['300到3000MHz', '30到300MHz', '300到3000kHz', '30到300kHz'],
  },
  {
    index: '[I]LK1114',
    question: 'HF段的频率范围是多少？',
    answer: ['3到30MHz', '30到300MHz', '300到3,000MHz', '300到3,000kHz'],
  },
  {
    index: '[I]LK0144',
    question: '我国分配给业余业务和卫星业余业务专用的频段有：',
    answer: [
      '7MHz、14MHz、21MHz、28MHz、47GHz频段',
      '7MHz、14MHz、21MHz、28MHz、144MHz频段',
      '3.5MHz、14MHz、21MHz、28MHz、10GHz频段',
      '7MHz、14MHz、28MHz、144MHz、430MHz频段',
    ],
  },
  {
    index: '[I]LK0146',
    ...
    answer: ['50MHz、144MHz', '144MHz、430MHz', '50MHz、430MHz', '220MHz、430MHz'],
  },
  {
    index: '[I]LK0147',
    question:
      '我国分配给业余业务和卫星业余业务与其他业务共用、并且业余业务和卫星业余业务作为唯一主要业务的频段的个数以及在3GHz以下的该类频段分别为：',
    answer: ['3个，144-146MHz', '4个，7.0-7.2MHz', '5个，50-54MHz', '5个，28-29.7MHz'],
  },
  {
    index: '[I]LK0148',
    question:
    ...
    answer: [
      ...
      '3.5MHz、7MHz、50MHz',
      '3.5MHz、18.068MHz、144MHz',
      '10.1MHz、24.89MHz、430MHz',
    ],
  },
  {
    index: '[I]LK0157',
    question: '俗称的6米业余波段的频率范围以及业余业务和卫星业余业务的使用状态分别为：',
    answer: ['50-54MHz，主要业务', '50-52MHz，次要业务', '51-54MHz，专用', '52-56MHz，次要业务'],
  },
  {
    index: '[I]LK0158',
    question: '俗称的2米业余波段的频率范围以及我国业余业务和卫星业余业务的使用状态分别为：',
    answer: [
      '144-148MHz；其中144-146MHz为唯一主要业务，146-148MHz为与其他业务共同作为主要业务',
      '144-146MHz；专用',
      '144-148MHz；其中144-146MHz为专用，146-148MHz为次要业务',
      '144-148MHz；次要业务',
    ],
  },
  {
  ...
  },
  {
    ...
    answer: ['无线电定位和航空无线电导航', '固定业务', '移动业务', '水上移动和航空移动'],
  },
  {
    index: '[I]LK0171',
    ...
    answer: [
      ...
      '144.035-145.8MHz',
      '144.050-144.053MHz和145.100-145.750MHz',
      '144.035-144.053MHz和145.550-145.750MHz',
    ],
  },
  {
    index: '[I]LK0172',
    ...
    answer: [
      '431.9-432.240MHz和435-438MHz',
      '430-431.9MHz和432.240-435MHz',
      '431-432MHz和438-440MHz',
      '430-431.2MHz和435-436MHz',
    ],
  },
  {
    index: '[I]LK1031',
    question: '430MHz业余频段中留给业余卫星通信使用，话音及其他通信方式不应占用的频率段为：',
    answer: ['435MHz至438MHz', '432MHz至434MHz', '438MHz至439MHz', '433MHz至435MHz'],
  },
  {
    index: '[I]LK1032',
    question: '144MHz业余频段中留给业余卫星通信使用，话音及其他通信方式不应占用的频率段为：',
    answer: ['145.8MHz至146MHz', '144.8MHz至145MHz', '144.2MHz至144.5MHz', '145.4MHz至144.6MHz'],
  },
  {
    index: '[I]LK0077',
    question: '《业余无线电台管理办法》规定业余无线电台设置、正确使用业余无线电台呼号的办法规是：',
    answer: [
  ...
  {
    index: '[I]LK0091',
    question: '设台地迁入其他省、自治区或者直辖市时，业余电台呼号的指配方法为：',
    answer: [
  ...
  {
    index: '[I]LK0092',
    question: '设台地迁入其他省、自治区或者直辖市时，申请在迁入地继续指配原来的电台呼号的手续为：',
    answer: [
  ...
  },
  {
    ...
    answer: ['B9/BH1AAA', 'BH1AAA/9', 'B1/BH9AAA', 'BH1AAA/B9'],
  },
  {
    index: '[I]LK0084',
    question:
  ...
  },
  {
    ...
    answer: [
      '可以。使用所操作业余电台的呼号，由该业余电台的设台人对操作不妥而造成的有害干负责',
      '可以。因为自己没有呼号，只能在通信中使用临时自编的呼号，或用姓名代替呼号',
      '不可以',
      '青少年可以，成人不可以',
    ],
  },
  {
    ...
    answer: [
      '必须已接受法规等基础培训、必须由电台负责人现场辅导、必须在执照核定范围以及国家规定的操作权限内、进行短时间体验性发射操作实习',
      '只要业余电台设置人或者其技术负责人能确认实际上已经具备操作技术能力，可以独立进行发射操作，并能为其操作不善造成的后果负责，可以独立发射操作',
      '尚未取得关于具备操作技术能力有效证明文件的人任何情况下都不可以进行发射操作',
      '尚未取得关于具备操作技术能力有效证明文件者如为青少年，可以在集体业余电台独立操作，如为成人则任何情况下都不可以进行发射操作',
    ],
  },
  {
    index: '[I]LK0065',
  ...
  {
    index: '[I]LK0247',
    question: '业余电台通信受到违法电台或者不明电台的有害干扰。正确的做法是：',
    answer: [
  ...
  {
    index: '[I]LK0075',
    question: '法规和国际业余无线电惯例要求业余电台日志记载的必要基本内容是：',
    answer: [
      '通信时间、通信频率、通信模式、对方呼号、双方信号报告',
      '通信对方姓名、对方所在国家或城市、通信模式、双方信号报告',
      '通信时间、通信频率、双方收发信设备和天线、对方台址',
      '通信时间、通信模式、对方信号报告、对方台址、对方天气',
    ],
  },
  {
    index: '[I]LK0076',
    ...
    answer: [
      ...
      'DATE、FREQ、QTH（对方）、RIG（对方）、RST（双方）、WX（对方）',
      'DATE、TIME、MODE、CALL（对方）、QTH（对方）、RST（双方）',
      'CALL（通信对方）、T IME、FREQ、RIG（对方）、RST（双方）、PWR（双方）',
    ],
  },
  {
    index: '[I]LK1011',
    question: '填写和邮寄QSL卡片时的正确做法有：',
    answer: [
      '迫切需要方卡回寄卡片时，应直接向对方地址邮寄卡片并附加SASE',
      '填写错误时应划去或使用涂改液覆盖错误内容并加以改正',
      '自己的邮寄地址与电台的发射地点不同时，应在QTH栏目内填明详细邮寄地址',
      '通过卡片管理局寄出卡片并希望对方回卡时，应在卡片上注明PSE QSL DIRECT',
    ],
  },
  {
    index: '[I]LK1042',
    question: '关于QSL卡片的正确用法是：',
    answer: [
      '不是作为联络或收听证明而交换QSL卡片时，应填上“Eye ball QSO”等有关说明，不应赠送空白卡片',
      '空白QSL卡片可以当做照片或者名片，任意赠送、交换、散发',
      '出于火腿互相帮助的目的，虽然对方没有联络到自己，也可以发去确认联络的QSL卡片',
      '如果在联络中没有听清对方呼号，可以在寄发QSL卡片的对方台名栏中填写对方操作员姓名',
    ],
  },
  {
    index: '[I]LK0034',
  ...
  {
    index: '[I]LK1096',
    question: '如果你知道另一个电台的呼号，想要在中继上呼叫他，你应该怎么做？',
    answer: [
      '呼叫对方的呼号，并报出自己的呼号',
  ...
  {
    index: '[I]LK0100',
    question: '对以不正当手段取得业余无线电台执照的，无线电管理机构可以给予下列处罚：',
    answer: [
      '责令限期改正，可以处警告或者三万元以下的罚款',
      '责令限期改正，可以处警告或者一千元以上，五千元以下的罚款',
      '责令限期改正，可以处警告或者一千元以下的罚款',
  ...
  {
    index: '[I]LK0102',
    question: '对违法使用业余无线电台造成严重后果的，无线电管理机构可以给予下列处罚：',
    answer: [
      '应当责令限期改正，可以处警告或者三万元以下的罚款',
      '应当责令限期改正，可以处警告或者一千元以上，五千元以下的罚款',
      '应当责令限期改正，可以处警告或者一千元以下的罚款',
  ...
  },
  {
    ...
    answer: [
      '对无线电波的发射、辐射和传播实施的强制性管理',
      '对无线电波的发射、辐射实施的指导和行业自律性管理',
      '对无线电发射设备的生产、销售实施的强制性管理',
      '对无线电发射设备的生产、销售实施的指导和行业自律性管理',
    ],
  },
  {
    index: '[I]LK0107',
    ...
    answer: [
      ...
      '限制或者禁止业余无线电台设备的生产和销售',
      '限制、但不会禁止业余无线电台（站）的使用',
      '依法设置的业余电台不在管制范围之内',
    ],
  },
  {
  ...
  {
    index: '[I]LK0233',
    question: '业余电台在发射调试信号进行发射功率和天线驻波比等检查时必须注意做到的是：',
    answer: [
  ...
  {
    index: '[I]LK0238',
    question: '业余电台BH1ZZZ用话音发起CQ呼叫的正确格式为：',
    answer: [
  ...
  {
    index: '[I]LK0241',
    question: '业余电台BH1ZZZ用话音呼叫BH8YYY的正确格式为：',
    answer: [
  ...
  {
    index: '[I]LK0244',
    question: 'BH1ZZZ希望加入两个电台正在通信中的谈话，正确的方法为：',
    answer: [
  ...
  {
    index: '[I]LK0245',
    question: '以请求插入的方式加入两个电台正在通信中的谈话，应满足的起码条件是：',
    answer: [
      '确认自己的加入不会影响原通信双方的乐趣',
      '自己的信号质量不亚于原通信双方',
      '自己的操作技巧不亚于原通信双方',
  ...
  {
    index: '[I]LK1046',
    question: '业余电台之间进行通信，必须相互正确发送和接收的信息为：',
    answer: [
      '本台呼号、对方呼号、信号报告',
      '本台呼号、对方呼号、QTH',
      '本台呼号、信号报告、QTH',
  ...
  {
    index: '[I]LK1098',
    question: '当一部电台在呼叫CQ时，他的意思是？',
    answer: [
      '非特指地呼叫任何一部电台',
      '此电台正在测试天线，不需要任何电台回答这个呼叫',
      '只有被呼叫的电台可以回答，其他人不能回答',
      '呼叫重庆的电台',
    ],
  },
  {
    ...
    answer: [
      '稍稍移动一下自己的位置，有时信号无规律反射造成的多径效应可能导致失真',
      '打开哑音发射功能',
      '请对方电台调整自己的静噪设置',
      '将你电台中的镍氢电池换成锂电池',
    ],
  ...
  {
    index: '[I]LK1131',
    question: '下列哪种方式可以让你快速切换到一个你经常使用的频率？',
    answer: [
      '将这个频率作为一个频道存储在电台中',
      '打开哑音输出',
      '关闭哑音输出',
  ...
  {
    index: '[I]LK0287',
    question: '“谁在呼叫我”的业余无线电通信Q简语为：',
    answer: ['QRZ？', 'QRZ', 'QRA？', 'QSL？'],
  },
  {
    index: '[I]LK0292',
    question: '“我遇到他台干扰”的业余无线电通信Q简语为：',
    answer: ['QRM', 'QSM', 'QRN', 'QSB？'],
  },
  {
    index: '[I]LK0294',
    question: '“我遇到天电干扰”的业余无线电通信Q简语为：',
    answer: ['QRN', 'QST', 'QSN', 'QRM'],
  },
  {
    index: '[I]LK0313',
    question: '“我给你收据（QSL卡片）、我已收妥”的业余无线电通信Q简语为：',
    answer: ['QSL', 'QRG', 'QSX', 'QRV'],
  },
  {
    index: '[I]LK0321',
    question: '“我的电台位置是××××”的业余无线电通信Q简语为：',
    answer: ['QTH　××××', 'QRD　××××', 'QSL　××××', 'QSP　××××'],
  },
  {
    index: '[I]LK0331',
    question: '“天线”的业余无线电通信常用缩语是：',
    answer: ['ANT', 'ATT', 'ATN', 'ATR'],
  },
  {
    index: '[I]LK0332',
    question: '业余无线电常用缩语“ARDF”的意思是：',
    answer: ['业余无线电测向', '天线调谐器、天调', '地址', '天线测试仪'],
  },
  {
    index: '[I]LK0352',
    question: '“频率”的业余无线电通信常用缩语是：',
    answer: ['FREQ', 'FER', 'TUNE', 'FIND'],
  },
  {
    index: '[I]LK0361',
    question: '业余无线电通信常用缩语“GND”的意思是：',
    answer: ['地线，地面', '格林威治时间', '好运气', '高兴'],
  },
  {
    index: '[I]LK0373',
    question: '业余无线电通信常用缩语“OM”的意思是：',
    answer: ['老朋友', '欧姆', '或者', '老人'],
  },
  {
    index: '[I]LK0376',
    question: '“电台设备”的业余无线电通信常用缩语是：',
    answer: ['RIG', 'REG', 'EQP', 'SB'],
  },
  {
    index: '[I]LK0379',
    question: '“收信机”的业余无线电通信常用缩语是：',
    answer: ['RCVR，RX', 'XCVR', 'XMTR', 'RMKS'],
  },
  {
    index: '[I]LK0380',
    question: '“发信机”的业余无线电通信常用缩语是：',
    answer: ['TX、XMTR', 'XTL', 'VXO', 'VXCO'],
  },
  {
    index: '[I]LK0381',
    question: '“收发信机”的业余无线电通信常用缩语是：',
    answer: ['XCVR', 'XVTR', 'XMTR', 'XTL'],
  },
  {
    index: '[I]LK0396',
    question: '业余无线电通信常用缩语“WX”的意思是：',
    answer: ['天气', '瓦特', '联络、工作', '星期'],
  },
  {
    index: '[I]LK0402',
    question: '业余无线电通信常用缩语“73”的意思是：',
    answer: ['向对方的致意、美好的祝愿', '再见', '希望下次再见', '谢谢你'],
  },
  {
    index: '[I]LK0404',
    question: '业余无线电通话常用语“Roger”的用法是：',
    answer: [
      '回答起始语，相当于“明白”，仅在已完全抄收对方刚才发送的信息时使用',
      '回答起始语，相当于“听到”，用于能听到对方信号、但不一定能全部抄收的情况',
      '回答起始语，表示开始发话了，任何情况都可使用',
      '惯用口头语，相当于电话的“喂”，仅提起注意，不包含任何意义',
    ],
  },
  {
    index: '[I]LK0405',
    question: '业余无线电通信中常用的天线种类的缩写DP代表：',
    answer: ['偶极天线', '长线天线', '定向天线', '垂直天线'],
  },
  {
    index: '[I]LK0407',
    question: '业余无线电通信中常用的天线种类的缩写GP代表：',
    answer: ['垂直接地天线', '对数周期天线', '偶极天线', '定向天线'],
  },
  {
    index: '[I]LK0408',
    question: '业余无线电通信中常用的天线种类的缩写BEAM代表：',
    answer: ['定向天线', '专指八木天线', '偶极天线', '垂直天线'],
  },
  {
    index: '[I]LK0409',
    question: '业余无线电通信中常用的天线种类的缩写YAGI代表：',
    answer: ['八木天线', '定向天线', '偶极天线', '垂直天线'],
  },
  {
    index: '[I]LK0410',
    question: '业余无线电通信中常用的天线种类的缩写VER代表：',
    answer: ['垂直天线', '垂直接地天线', '定向天线', '偶极天线'],
  },
  {
    index: '[I]LK0193',
  ...
  {
    index: '[I]LK0202',
    question: '我国所属的“CQ分区”有：',
    answer: ['23、24、27', '42、43、44', '23、24', '42、43、44、50'],
  },
  {
    index: '[I]LK0204',
    question: '“ITU分区”是IARU的活动计算通信成绩的基础。我国所属的“ITU分区”有：',
    answer: ['33、42、43、44、50', '33、42、43、44', '23、24', '23、24、27'],
  },
  {
    index: '[I]LK0862',
    question: '业余无线电通信梅登海德网格定位系统（Maidenhead Grid Square Locator）是一种：',
    answer: [
  ...
  {
    index: '[I]LK0863',
    question: '业余无线电通信常用的梅登海德网格定位系统网格名称的格式为：',
    answer: [
  ...
  {
    index: '[I]LK1208',
    question: '业余无线电通信所说的“网格定位”是什么意思？',
    answer: [
      '一个由一串字母和数字确定的地理位置',
      '一个由一串字母和数字确定的方位角和仰角',
      '用来调谐末级功放的设备',
  ...
  },
  {
    index: '[I]LK0431',
    question: '电流的单位是：',
    answer: ['安（培）', '伏（特）', '瓦（特）', '欧（姆）'],
  },
  {
    index: '[I]LK0432',
    question: '电压的单位是：',
    answer: ['伏（特）', '安（培）', '瓦（特）', '欧（姆）'],
  },
  {
    index: '[I]LK0433',
    question: '电阻的单位是：',
    answer: ['欧（姆）', '安（培）', '伏（特）', '瓦（特）'],
  },
  {
    index: '[I]LK0434',
    question: '功率的单位是：',
    answer: ['瓦（特）', '安（培）', '伏（特）', '欧（姆）'],
  },
  {
    index: '[I]LK0466',
    question: '无线电常用度量单位的词头K的意义为：（”x＾m”表示“x的m次方”）',
    answer: ['10＾3', '10＾(-3)', '10＾6', '10＾(-6)'],
  },
  {
    index: '[I]LK0467',
    question: '无线电常用度量单位的词头m的意义为：（”x＾m”表示“x的m次方”）',
    answer: ['10＾(-3)', '10＾3', '10＾6', '10＾(-6)'],
  },
  {
    index: '[I]LK0468',
    question: '无线电常用度量单位的词头M的意义为：（”x＾m”表示“x的m次方”）',
    answer: ['10＾6', '10＾(-6)', '10＾3', '10＾(-3)'],
  },
  {
    index: '[I]LK0469',
    question: '无线电常用度量单位的词头μ的意义为：（”x＾m”表示“x的m次方”）',
    answer: ['10＾(-6)', '10＾6', '10＾(-3)', '10＾3'],
  },
  {
    index: '[I]LK0470',
    question: '无线电常用度量单位的词头G的意义分别为：（”x＾m”表示“x的m次方”）',
    answer: ['10＾9', '10＾6', '10＾12', '10＾(-12)'],
  },
  {
    index: '[I]LK0471',
    question: '无线电常用度量单位的词头n的意义分别为：（”x＾m”表示“x的m次方”）',
    answer: ['10＾(-9)', '10＾9', '10＾12', '10＾(-12)'],
  },
  {
    index: '[I]LK0472',
    question: '无线电常用度量单位的词头T的意义分别为：（”x＾m”表示“x的m次方”）',
    answer: ['10＾12', '10＾-12', '10＾9', '10＾(-9)'],
  },
  {
    index: '[I]LK0473',
    question: '无线电常用度量单位的词头p的意义分别为：（”x＾m”表示“x的m次方”）',
    answer: ['10＾(-12)', '10＾12', '10＾(-9)', '10＾9'],
  },
  {
    index: '[I]LK0495',
    question: '音频所指的频率范围大致是：',
    answer: ['16Hz - 20kHz', '300Hz - 3000Hz', '16kHz - 20kHz', '16kHz - 56kHz'],
  },
  {
    index: '[I]LK0566',
    question: '5W可以表示为：',
    answer: ['37dBm', '5dBW', '17dBm', '35dBμ'],
  },
  {
    index: '[I]LK0567',
    question: '0.25W可以表示为：',
    answer: ['54dBμ', '6dBW', '36dBm', '25dBm'],
  },
  {
    index: '[I]LK0568',
    question: '0.4kW可以表示为：',
    answer: ['86dBμ', '400dBm', '6000dBm', '34dBm'],
  },
  {
    index: '[I]LK0438',
    question: '电源两端电压的方向为：',
  ...
  {
    index: '[I]LK0512',
    question: '峰-峰值为100伏的正弦交流电压，其有效值电压为：',
    answer: ['约35.4伏', '约70.7伏', '约141伏', '约50伏'],
  },
  {
    index: '[I]LK0513',
    question: '峰值为100伏的正弦交流电压，其有效值电压为：',
    answer: ['约70.7伏', '约35.4伏', '约141伏', '约50伏'],
  },
  {
    index: '[I]LK0518',
    question: '峰-峰值为100伏的正弦交流电压，其平均值电压为：',
    answer: ['0', '约35.4伏', '约70.7伏', '约141伏'],
  },
  {
    index: '[I]LK0519',
    question: '峰值为100伏的正弦交流电压，其平均值电压为：',
    answer: ['0', '约35.4伏', '约70.7伏', '约141伏'],
  },
  {
    index: '[I]LK0529',
  ...
  {
    index: '[I]LK1107',
    question: '下面哪一个术语可以用来描述交流电每秒改变方向的次数？',
    answer: ['频率', '速率', '波长', '脉率'],
  },
  {
    index: '[I]LK1134',
    question: '电流使用下列哪一个单位来衡量？',
    answer: ['安培', '瓦特', '欧姆', '伏特'],
  },
  {
    index: '[I]LK1135',
    question: '电功率使用如下哪一个单位来衡量？',
    answer: ['瓦特', '伏特', '欧姆', '安培'],
  },
  {
    index: '[I]LK1136',
    question: '只向一个方向流动的电流叫做什么？',
    answer: ['直流', '交流', '常流', '平流'],
  },
  {
    index: '[I]LK1138',
    question: '下列哪一项是电的良导体？',
    answer: ['铜', '木材', '玻璃', '橡胶'],
  },
  {
    index: '[I]LK1139',
    question: '下列哪一项是电的良好绝缘体？',
    answer: ['玻璃', '铜', '铝', '汞'],
  },
  {
    index: '[I]LK1140',
    question: '电能消耗的速率叫做什么？',
    answer: ['电功率', '电流', '电阻', '电压'],
  },
  {
    index: '[I]LK0123',
    question: '用通常的调频方式进行话音通信，必要带宽约为：',
    answer: ['6.25kHz', '2700Hz', '200Hz', '12.5kHz'],
  },
  {
    index: '[I]LK0138',
    question: '无线电干扰中不属于有害干扰的是：',
    answer: [
  ...
  {
    index: '[I]LK0416',
    question: '可以组成完整无线电接收系统的功能部件组合是：',
    answer: [
      '接收天线、解调器、输出部件',
      '射频放大器、变频器、中频放大器',
      '接收天线、射频放大器、中频放大器',
  ...
  {
    index: '[I]LK0417',
    question: '可以组成完整无线电发信系统的功能部件组合是：',
    answer: [
      '射频振荡器、调制器、发射天线',
      '话音放大器、射频振荡器、射频功率放大器',
      '键控电路、侧音电路、天线调谐器',
      '射频振荡器、射频功率放大器、驻波测量电路',
    ],
  },
  {
    index: '[I]LK0418',
    question: '无线电发射机调制部件的作用是：',
    answer: [
      '以原始信号控制射频信号的幅度、频率、相位参数',
      '以电能转换效率最高的方式控制射频功率放大器的工作点',
      '调整天馈系统的参数达到阻抗匹配',
      '自动控制发射信号的频谱使其保持在核准的必要带宽范围内',
    ],
  },
  {
    index: '[I]LK0420',
    question: '发射天线的作用是：',
    answer: [
      '把无线电发射机输出的射频信号电流转换为空间的电磁波',
      '通过天线的增益对无线电发射机输出的射频信号加以放大',
      '把无线电发射机放大后的音频话音信号转换为音频电磁场',
      '把无线电发射机输出的射频信号电流转换为热能',
    ],
  },
  {
    index: '[I]LK0421',
    question: '接收天线系统的作用是：',
    answer: [
      '把空间的有用电磁波转换为射频电压电流信号',
      '通过天线的增益将空间有用电磁波的能量加以放大',
      '把空间的有用电磁波转换为热能',
      '把空间的有用电磁波转换为音频电压电流信号',
    ],
  },
  {
    index: '[I]LK0422',
    ...
    answer: [
      '良好的抗干扰能力，足够高的灵敏度，尽量低的本机噪声和信号失真',
      '尽量宽而平坦的音频频率响应',
      '尽量宽的接收频率覆盖范围',
      '尽量大的音频输出功率',
    ],
  ...
  },
  {
    ...
    answer: ['简单正弦波', '对称方波', '单个无限窄脉冲', '连续的无限窄脉冲'],
  },
  {
    index: '[I]LK0536',
    question: '在整个频谱内具有连续的均匀频率分量的信号是：',
    answer: ['单个无限窄脉冲', '简单正弦波', '对称方波', '连续的无限窄脉冲'],
  },
  {
    index: '[I]LK0572',
    question: '包含多个频率分量的信号通过滤波器会发生下列现象：',
    answer: ['频率失真', '非线性失真', '自激振荡', '检波'],
  },
  {
    index: '[I]LK0689',
    question:
    ...
    answer: [
      ...
      '开关电源使用了半导体器件，不需要变压器',
      '开关电源使用轻质铝材做散热器，不需要通过笨重的铁芯变压器散热',
      '开关电路中半导体元器件的损耗小，可以使用轻巧的小规格元器件',
    ],
  },
  {
    index: '[I]LK0713',
    question: '一个FM话音信号在频谱仪上显示为：',
    answer: [
      '一条固定的垂直线，左右伴随一组对称的随语音出现和变化的垂直线',
      '一条随语音闪烁的直线',
      '多条固定的直线',
      '一条复杂的周期性曲线',
    ],
  },
  {
    ...
    answer: ['频谱图', '波形图', '相位矢量图', '星座图和眼图'],
  },
  {
    index: '[I]LK0784',
    question: '业余无线电通信最常用的三种基本调制方法，其缩写AM、FM和PM，它们的中文名称分别是：',
    answer: [
      '幅度调制（调幅）、频率调制（调频）、相位调制（调相）',
      '幅度调制（调幅）、频率调制（调频）、脉宽调制（调脉宽）',
      '频率调制（调频）、脉码调制（调脉码）、幅度调制（调幅）',
      '幅度调制（调幅）、频率调制（调频）、电码调制（摩尔斯）',
    ],
  },
  {
    index: '[I]LK0786',
    question: '对于给定的FM发射设备，决定其射频输出信号实际占用带宽的因素是：',
    answer: [
      '所传输信号的最高频率越高、幅度越大，射频输出占用带宽越宽',
      '所传输信号的最高频率越高，射频输出占用带宽越宽，但与其幅度无关',
      '所传输信号的幅度越大，射频输出占用带宽越宽，但与其频率无关',
      '射频输出实际占用带宽为由电路决定的固定值，通信常用的是25kHz或12.5kHz',
    ],
  },
  {
    index: '[I]LK0791',
    ...
    answer: [
      '对调频信号进行解调的过程称为鉴频',
      '判断信号频率是否超过允许的频率范围的过程称为鉴频',
      '判断信号频率是否发生了不应有的偏离或者漂移过程称为鉴频',
      '对调幅信号进行解调的过程称为鉴频',
    ],
  },
  {
    index: '[I]LK0813',
    question: '无线电发射机的效率是指：',
    answer: [
  ...
  },
  {
    ...
    answer: [
      ...
      '关闭静噪电路时所能接收到的最小射频信号的输入电平',
      '带有静噪功能的接收机开启静噪功能时，按照灵敏度定义测得的灵敏度',
      '带有静噪功能的接收机关闭静噪功能时，按照灵敏度定义测得的灵敏度',
    ],
  },
  {
    index: '[I]LK0854',
    question: '“衰减”和“衰落”是无线电通信技术中常用的名词。它们的含义分别是指：',
    answer: [
      '衰减是指信号通过信道或电路后功率减少，衰落是指信号通过信道或电路后发生幅度随时间而起伏',
      '衰减是指信号通过信道或电路后发生幅度随时间而起伏，衰落是指信号通过信道或电路后功率减少',
      '衰减和衰落是一回事，指信号通过信道或电路后功率减少',
      '衰减和衰落是一回事，指信号通过信道或电路后发生幅度随时间而起伏',
    ],
  },
  {
    index: '[I]LK1044',
    question: '无线电发信机在无调制情况下，在一个射频周期内供给天线馈线的平均功率称为：',
    answer: ['载波功率', '无用功率', '平均功率', '峰包功率'],
  },
  {
    index: '[I]LK1099',
    question:
      '调频发射机在发射的语音信号上附加一个人耳听不到的低频音频，用来打开接收机的静噪。这一技术的常用名词是：',
    answer: ['CTCSS', '单音频脉冲', 'DTMF', '载波静噪'],
  },
  {
    index: '[I]LK1100',
  ...
  {
    index: '[I]LK1177',
    question: '下列哪一项术语表述了接收机区分不同信号的能力？',
    answer: ['选择性', '灵敏度', '扫描速度', '本底噪声'],
  },
  {
    index: '[I]LK1180',
    question: '接收机“过载”通常是指：',
    answer: [
      '输入信号过于强大，以致导致机内产生附加干扰',
      '接收机消耗的电流太大了',
      '接收机电源的电压太高了',
      '由于接收机的音量调节得过大而导致的附加干扰',
    ],
  },
  {
    index: '[I]LK1202',
    question: '以下哪种语音调制常被用于长距离弱信号的VHF或UHF联络？',
    answer: ['SSB', 'AM', 'FM', 'PM'],
  },
  {
    index: '[I]LK1203',
    question: '下列哪种调制被VHF和UHF业余电台本地通信广泛使用？',
    answer: ['FM', 'SSB', 'PSK', 'AM'],
  },
  {
    index: '[I]LK0702',
    question: '由半波长偶极天线和馈电电缆构成的天馈系统，理想的工作状态是：',
    answer: [
      '天线上只有驻波，馈线上只有行波',
      '天线上只有行波，馈线上只有驻波',
      '天线和馈线上都只有驻波',
  ...
  {
    index: '[I]LK0904',
    question: '在零仰角附近具有主辐射瓣的垂直接地天线，其振子的长度应为：',
    answer: ['1/4波长的奇数倍', '1/4波长的任意整数倍', '1/4波长的偶数倍', '1/2波长的奇数倍'],
  },
  {
    index: '[I]LK0910',
    question: '在为业余电台选购射频电缆作为天线馈线时，最重要的两项电气参数是：',
    answer: [
      '特性阻抗和工作频率下单位长度的传输功率损耗',
      '铜或铝导线的截面积和常温下的最大额定电流',
      '导线绝缘层的耐压和最高额定环境温度',
      '长度为1/4波长、终端分别为开路和短路时的电压驻波比',
    ],
  },
  {
    index: '[I]LK0918',
    question: '通常把垂直偶极天线或者垂直接地天线称为“全向天线”，是因为：',
    answer: [
      '它们在水平方向没有指向性，但在立体空间有方向性',
      '它们在垂直方向没有指向性，但在立体空间有方向性',
      '它们在水平方向和垂直方向都有指向性',
      '它们在空间没有指向性，向各个方向均匀辐射',
    ],
  },
  {
    index: '[I]LK0919',
    question: '振子电气长度为1/4波长的垂直接地天线的最大辐射方向为：',
    answer: [
      '在水平方向没有指向性，在垂直方向指向水平面',
      '在空间没有指向性，向各个方向均匀辐射',
      '在垂直方向没有指向性，在水平方向指向前方',
      '在水平方向呈现8字形方向特性',
    ],
  },
  {
    ...
    answer: [
      '缺乏有效的接地反射体。GP天线必须有足够大的接地反射体来形成振子镜像，否则谐振频率和阻抗都将与理论值有显著偏差，应尽量用大面积金属体与天线的接地端直接连接',
      '1/4波长垂直振子太短。改成1/2波长即可解决问题',
      '1/4波长垂直振子太短。在振子中串联加感线圈即可解决问题',
      '一般天线与电缆直接相连，匹配不良。在天线和电联之间加接“巴伦”即可解决问题',
    ],
  },
  {
    index: '[I]LK0926',
    ...
    answer: [
      ...
      '天线在接收或发射信号时所具有的放大倍数',
      '天线辐射到空间的电磁波功率与输入到天线的总射频功率之比',
      '输入到天线的总射频功率与天线辐射到空间的电磁波功率之比',
    ],
  },
  {
    index: '[I]LK0929',
    question: '某商品天线说明书给出的增益指标以dBi为单位。其意义为：',
    answer: [
  ...
  {
    index: '[I]LK0930',
    question: '某商品天线说明书给出的增益指标以dBd为单位。其意义为：',
    answer: [
      '“相对于半波长偶极子天线的增益”，即最大辐射方向上的辐射功率密度与半波长偶极振子的最大辐射功率密度之比',
      '“相对于无方向性点源天线的增益”，即最大辐射方向上的辐射功率密度与理想点源天线的辐射功率密度之比',
      '“相对于1/4波长接地天线的增益”，即以1/4波长垂直接地天线作为比较基准得到的天线增益',
  ...
  {
    index: '[I]LK0931',
    question: '某商品天线说明书给出的增益指标以dB为单位。其意义为：',
    answer: [
      '这种表达没有说清楚计算增益所采用的比较基准，缺乏实际意义',
      '“相对于半波长偶极子天线的增益”，即最大辐射方向上的辐射功率密度与半波长偶极振子的最大辐射功率密度之比',
      '“相对于无方向性点源天线的增益”，即最大辐射方向上的辐射功率密度与理想点源天线的辐射功率密度之比',
  ...
  {
    index: '[I]LK1126',
    question: '安装哪个部件可以减少在音频同轴电缆屏蔽层外皮中的感应射频电流？',
    answer: [
      '在电缆外面套铁氧体磁环',
      '在电缆芯线中串联低通滤波器',
      '在电缆前端前置放大器',
  ...
  {
    index: '[I]LK1184',
    question: '下列哪一个设备可以用来测定天线当前的谐振频率？',
    answer: ['天线分析仪', '频率计数器', '品质因数计', '电子管电压表'],
  },
  {
    index: '[I]LK1185',
    question: '在业余无线电通信中，“驻波比”通常用来衡量：',
    answer: ['负载与传输线的匹配质量', '传输线的制造质量', '发射机的能效比', '电台接地的质量'],
  },
  {
    index: '[I]LK1186',
    question: '天线与馈线完美匹配时，在驻波表中显示的驻波比是？',
    answer: ['1:1', '1:3', '2:1', '0'],
  },
  {
    index: '[I]LK1188',
    question: '馈线中的功率损耗会？',
    answer: ['变成热量', '传回你的发射机并可能导致损害', '使驻波比增加', '使你的信号失真'],
  },
  {
    index: '[I]LK1189',
    question: '导致同轴电缆损害的最常见的原因是什么？',
    answer: ['电缆受潮', '伽马射线', '速度因子超过了1', '过载'],
  },
  {
    index: '[I]LK1190',
    question: '为什么要求同轴电缆的外皮能抵挡紫外线？',
    answer: [
      '紫外线能破坏电缆的外皮，使水分渗入',
      '紫外线会使电缆外皮中的功率损耗加大',
      '紫外线和射频信号会混合在一起导致干扰',
  ...
  {
    index: '[I]LK1191',
    question: '和固体电介质同轴电缆相比，空气电介质同轴电缆的劣势是什么？',
    answer: [
  ...
  {
    index: '[I]LK1213',
    question: '就大多数手持电台随机附送的“橡皮天线”来说，它的劣势是什么？',
    answer: [
      '相对于全尺寸天线，它的发射和接收效率较低',
      '它发射的是圆极化的信号',
      '如果橡胶的一头损坏了，那么它很快就会解体',
      '以上三项全部正确',
    ],
  },
  {
    ...
    question: '天线的增益是什么意思？',
    answer: [
      '相对于参考天线，在某一方向上信号强度的增加',
      '当发射机在更高的频率发射时，天线会额外地减少一部分功率',
      '对于发射机的功率输入，天线附加的一部分额外功率',
      '相对于参考天线，发射或接收时的阻抗增加',
    ],
  },
  {
    index: '[I]LK1217',
    question: '为什么在使用同轴电缆连接天线时，最好有一个较低的驻波比？',
    answer: [
      '使能量更有效率地传送，减少损耗',
      '减少对电视的干扰',
      '能延长天线的使用寿命',
  ...
  {
    index: '[I]LK1218',
    question: '业余无线电普遍使用的同轴电缆的特性阻抗是？',
    answer: ['50欧姆', '8欧姆', '600欧姆', '12欧姆'],
  },
  {
    index: '[I]LK1219',
    question: '为什么同轴电缆在业余无线电界的使用相对于其他馈线来说更多？',
    answer: [
      '因为它使用方便，与周围环境之间的相互影响小',
      '因为它比其它任何一种馈线的损耗都低',
      '因为它可以相对其它馈线传送更大的功率',
      '因为它比其它任何一种馈线都便宜',
    ],
  ...
  {
    index: '[I]LK1221',
    question: '通过同轴电缆的信号频率越高，通常产生什么影响？',
    answer: ['损耗越高', '反射功率越高', '特性阻抗越高', '驻波比越高'],
  },
  {
    index: '[I]LK1222',
    question: '对于400MHz以上的信号，通常会使用的同轴电缆连接器是：',
    answer: ['N型连接器', 'M型连接器', 'RS-213型连接器', 'DB-23型连接器'],
  },
  {
    index: '[I]LK1223',
    question: '下列哪一项有可能导致驻波比不稳定读数的？',
    answer: [
      '天线与馈线的连接头接触不良',
      '发射机采用了频率调制',
      '发射机过调制',
  ...
  {
    index: '[I]LK1224',
    question: '下列馈线中，哪一种在VHF和UHF频段的损耗最小？',
    answer: ['空气介质同轴硬电缆', '多芯不平衡电缆', '50欧姆同轴软电缆', '75欧姆同轴软电缆'],
  },
  {
    index: '[I]LK0972',
    question: '无线电波在真空中的速度大致为：（”x＾m”表示“x的m次方”）',
    answer: ['3×10＾8 米/秒', '3.1416×10＾12 米/秒', '3×10＾7 米/秒', '6.88×10＾6 米/秒'],
  },
  {
    index: '[I]LK0973',
    question:
      '天线工程中计算振子长度时需要知道电波在天线中的传播速度。电波在天线导线中的传播速度大约是：',
    answer: ['真空波速的0.95倍', '真空波速的1.05倍', '与真空波速相同', '真空波速的1.41倍'],
  },
  {
    index: '[I]LK0974',
    question:
      '天线工程中计算馈线长度时经常需要知道电波在馈线中的传播速度。常用业余频段的电波在同轴电缆中的传播速度大约是：',
    answer: ['真空波速的0.65倍', '真空波速的1.54倍', '真空波速的1.65倍', '与真空波速相同'],
  },
  {
    index: '[I]LK1058',
    question: '无线电波按传播方式可主要分为下列种类：',
    answer: [
      '地面波、天波、空间波、散射波等',
      '长波、中波、短波、超短波、微波等',
      '调幅波、调频波、调相波等',
  ...
  {
    index: '[I]LK1060',
    question: '无线电波在自由空间中的传播路径损耗遵循下列规律：',
    answer: [
      '与距离的平方成正比，与频率的平方成正比',
      '与距离的平方成正比，与频率的平方成反比，',
      '与距离成正比，与频率的平方成正比',
  ...
  {
    index: '[I]LK1067',
    question: '地波是沿地面传播的无线电波，其衰减因子取决于：',
    answer: [
      '电波频率、地面导电率和传播距离',
      '电波频率、太阳活动情况和地磁活动情况',
      '电波频率、发射功率和天线增益',
  ...
  },
  {
    ...
    answer: [
      '发射天线和接收天线离地面的相对高度值',
      '发射天线和接收天线离海平面的绝对高度值',
      '发射天线和接收天线离地面的相对于波长的高度系数，即离地高度除以波长',
      '发射天线和接收天线的增益',
    ],
  },
  {
    index: '[I]LK1104',
    question: '多径传播对UHF波段或VHF波段数据通信的影响是：',
    answer: [
      '可能使误码率增大',
      '随着传播路径的增加，接收到的数据速率会线性地减小',
      '如果使用FM方式调制的话，不会观察到任何反常现象',
      '随着传播路径的增加，数据通信速率会线性地增加',
    ],
  },
  {
    index: '[I]LK1106',
    question: '在一个周期内，电磁波走过一定的距离，这个距离叫做：',
    answer: ['波长', '波形', '波速', '波展'],
  },
  {
    index: '[I]LK1108',
    question: '无线电波的两个组成部分是？',
    answer: ['电场和磁场', '电压和电流', '直流和交流', '电离辐射和非电离辐射'],
  },
  {
    index: '[I]LK1109',
    question: '无线电波的传播速度有多快？',
    answer: ['和光速一样', '和音速一样', '和它的波长成反比例关系', '速度随着频率的增加而增加'],
  },
  {
    index: '[I]LK1110',
    question: '无线电波的频率和它的波长有什么样的关系？',
    answer: [
      '如果频率增加，则波长变短',
      '如果频率增加，则波长变长',
      '波长与频率之间没有固定的联系',
  ...
  {
    index: '[I]LK1111',
    question: '在已知电磁波频率的情况下，下面哪一种方法可以用来计算它的波长？',
    answer: [
  ...
  {
    index: '[I]LK1115',
    question: '在自由空间中，无线电波的速度约是多少？',
    answer: ['300000000米/每秒', '3000千米/每秒', '300000英里/每小时', '18600英里/每小时'],
  },
  {
    index: '[I]LK1116',
    question: '如果你收到了一个从上千公里以外的距离传播过来的VHF信号，最可能的原因是：',
    answer: [
      '信号被突发E电离层反射过来',
      '信号经过了地下传输过来',
      '信号被附近的雷雨区反射过来',
  ...
  {
    index: '[I]LK1143',
    question: '下列哪一个缩写经常在无线电工程文章中用来代表各种类型的无线电波？',
    answer: ['RF', 'HF', 'AF', 'VHF'],
  },
  {
    index: '[I]LK1144',
    question: '在空间中传播的电磁波，一般被叫做什么？',
    answer: ['无线电波', '声波', '重力波', '压力波'],
  },
  {
    index: '[I]LK0255',
    question: '收发信机面板上或设置菜单中的符号VOX代表什么功能？',
    answer: [
      '发信机声控，接入后将根据对话筒有无语音输入的判别自动控制收发转换',
      '自动天线调谐，对天线电路的电压驻波比进行检测并进行自动补偿，以维持最小驻波比',
      '发信自动电平控制，对射频输出电平进行检测并反馈控制，以维持其在适当限度之内',
      '发信自动音量控制，对音频输入电平进行检测并反馈控制，以维持其在适当限度之内',
    ],
  },
  {
    index: '[I]LK0258',
    ...
    answer: [
      '按键发射，有信号（一般为对地接通）时发射机由等待转为发射',
      '发信语音压缩，对音频输入电平进行检测并反馈控制，以提升语音包络幅度较小的部分',
      '收信机前置放大器，在接收微弱信号时接入（此时某些技术指标可能低于额定值）',
      '自动天线调谐，对天线电路的电压驻波比进行检测并进行自动补偿，以维持最小驻波比',
    ],
  },
  {
  ...
  },
  {
    ...
    answer: [
      'NFM为窄带调频方式，适用于信道带宽25kHz/12.5kHz的通信信号；WFM为宽带调频方式，适用于接收信道带宽180kHz左右的广播信号',
      'NFM代表数字化语音方式，WFM代表模拟语音方式',
      'NFM为调频通信本地方式（较低灵敏度），WFM为调频通信远程方式（最高灵敏度）',
      'NFM为单频率守候方式，WFM为双频率守候方式',
    ],
  },
  {
    index: '[I]LK0261',
    ...
    answer: [
      '双音多频编码，由8个音调频率中的两个频率组合成的控制信号，代表16种状态之一，用于遥控和传输数字等简单字符',
      '亚音调静噪，即从67-250.3Hz的38个亚音调频率中选取一个作为选通信号，代表38种状态之一，接收机没有收到特定的选通信号时自动关闭音频输出',
      '数字设备识别码，即在松开PTT按键时自动发送一串代表设备代号的二进制数据',
      '自动静噪，即在接收机没有收到信号时自动关闭音频输出',
    ],
  },
  {
    index: '[I]LK0262',
  ...
  },
  {
    ...
    answer: [
      '不能。因为鉴频输出大小只取决于射频信号的频偏，而且正常信号的幅度会被限幅电路切齐到同样大小',
      '不能。因为信号越强，自动增益控制作用也越强，增益的急剧减小使声音反而被压低',
      '能。最后的信号是接收到的射频信号经过放大处理得到的，当然信号强声音越大',
      '能。调频信号越强，频偏也必然越大，解调后的声音也越大',
    ],
  },
  {
    index: '[I]LK0788',
    question: '用设置在NFM方式的对讲机接收WFM信号，其效果为：',
    answer: [
      '可以听到信号，但当调制信号幅度较大、音调较高时会发生明显非线性失真',
      '听不到信号，但接收到信号时调频噪声会变得寂静',
      '可以正常听到信号，但声音的高音频部分衰减较大，缺乏高音',
      '可以正常听到信号，但声音比较小',
    ],
  },
  {
    index: '[I]LK0789',
    question: '用设置在WFM方式的对讲机接收NFM信号，其效果为：',
    answer: [
      '可以正常听到信号，但声音比较小',
      '可以听到信号，但当调制信号幅度较大、音调较高时会发生明显非线性失真',
      '听不到信号，但接收到信号时调频噪声会变得寂静',
  ...
  {
    index: '[I]LK0790',
    question: '调频接收机没有接收到信号时，会输出强烈的噪声。关于这种噪声的描述是：',
    answer: [
      '由天线背景噪声和机内电路噪声的随机频率变化经鉴频形成，其大小与天线接收到的背景噪声幅度无关',
      '由天线接收到的背景噪声的随机幅度变化经放大形成，其大小与天线背景噪声电压成正比',
      '由天线接收到的背景噪声的随机幅度变化经放大形成，其大小与天线背景噪声电压的平方成正比',
      '由天线接收到的背景噪声的随机幅度变化经放大形成，其大小与天线背景噪声电压的平方根成正比',
    ],
  },
  {
    index: '[I]LK0855',
    ...
    answer: [
      '可能是中继台附近的两个其他发射机的强信号在中继台上行频率造成了互调干扰',
      '肯定是中继台接收机受到了人为恶意干扰',
      '可能是中继台接收机发生了寄生振荡',
      '可能是中继台发射机发生了寄生振荡',
    ],
  ...
  },
  {
    ...
    answer: [
      '直射和经地面反射等多条路径到达的电波相位不同，互相叠加或抵消造成衰落（多径效应）',
      '收发位置之间的空气流动造成电波折射不均匀而飘移',
      '不同接收位置大地导电率有差异',
      '移动过程中设备与大地之间的分布电容发生微小的变动',
    ],
  },
  {
    index: '[I]LK1065',
    ...
    answer: [
      '多径传播，各路径到达的信号相位延迟不同而互相干涉',
      '发射机到两接收点传播距离不同造成传播路径衰耗不同',
      '大气扰动影响',
      '地磁影响影响',
    ],
  },
  {
    index: '[I]LK1130',
    question: '收发信机中的静噪控制的目的是什么？',
    answer: [
      '在没有信号的情况下，关闭音频输出，使其不会输出噪音。',
      '控制发射机的输出功率',
      '可以进行自动增益控制',
      '使接收机的输出音量调到最大',
    ],
  ...
  {
    index: '[I]LK1182',
    question: '如果对方报告你的调频电台发射的信号听起来失真严重、可辨度差，可能的原因是：',
    answer: ['三项都可能', '电台的电源电压不足', '电台所处的位置不好', '电台的发射频率不准确'],
  },
  {
    index: '[I]LK1237',
    question:
    ...
    answer: [
      '分别表示信道间隔为25kHz或者12.5kHz',
      '全频偏方式下发射频率的误差比半频偏方式大一倍',
      '全频偏方式适用于收发异频的中继台通信，半频偏方式适用于同频对讲通信',
      '全频偏方式语音信号经过压缩，半频偏方式语音信号只压缩低音频分量',
    ],
  },
  {
    index: '[I]LK0436',
  ...
  {
    index: '[I]LK0482',
    question: '测量一个元件是否短路，应该使用：',
    answer: ['万用电表的电阻挡', '万用电表的电压挡', '万用电表的电流挡', '频谱分析仪'],
  },
  {
    index: '[I]LK0483',
    question: '大致判断一个干电池是否已经失效，应该使用：',
    answer: ['万用电表的电压挡', '万用电表的电阻挡', '万用电表的电流挡', '音频信号发生器'],
  },
  {
    index: '[I]LK0691',
    question: '通信或家用设备的劣质开关电源会造成对无线电接收机的电磁干扰，其源头主要是：',
    answer: [
      '开关电路的谐波辐射',
      '工频电源变压器漏磁感应',
      '开关电源中整流电路的滤波电容容量不足',
  ...
  {
    index: '[I]LK1064',
    question: '家用微波炉一般的工作频带是：',
    answer: ['UHF（特高频）', 'VHF（甚高频）', 'SHF（超高频）', 'EHF（极高频）'],
  },
  {
    index: '[I]LK1122',
    question: '下列哪种设备可以用来代替普通的扬声器，可在嘈杂的环境中更好地抄收语音信号？',
    answer: ['耳机', '低通滤波器', '视频显示器', '吊杆话筒'],
  },
  {
    index: '[I]LK1137',
    question: '移动车载电台通常使用的电源电压是？',
    answer: ['约12伏特', '约30伏特', '约120伏特', '约240伏特'],
  },
  {
    index: '[I]LK1151',
    question: '下列哪一项可以在电路电流严重过载时保护电路不受损坏？',
    answer: ['熔断器', '电容', '屏蔽层', '电感'],
  },
  {
    index: '[I]LK1153',
    question: '一个新的干电池的标称电压是多少？',
    answer: ['1.5伏', '1.0伏', '1.2伏', '2.2伏'],
  },
  {
    index: '[I]LK1154',
    question: '下列哪一种电池不能充电？',
    answer: ['碱性电池', '镍镉电池', '铅酸电池', '锂离子电池'],
  },
  {
    index: '[I]LK1162',
    question: 'LED是什么的缩写？',
    answer: ['发光二极管', '液晶显示', '阴极射线管', '场效应管'],
  },
  {
    index: '[I]LK1163',
    question: 'LCD是什么的缩写？',
    answer: ['液晶显示器', '发光二极管', '阴极射线管', '场效应管'],
  },
  {
    index: '[I]LK1167',
    question: '下列哪一项设备可以把交变电流变成变化的直流？',
    answer: ['整流器', '变压器', '放大器', '反射器'],
  },
  {
    index: '[I]LK1169',
    question: '下列部件中经常被用来把220伏的市电转换成更低电压交流电的是：',
    answer: ['变压器', '可变电容器', '晶体管', '二极管'],
  },
  {
    index: '[I]LK1170',
    question: '下列器件中能够当做指示灯使用的是：',
    answer: ['LED', 'FET', '齐纳二极管', '双极型晶体管'],
  },
  {
    index: '[I]LK1192',
    question: '如何把一个电压表正确地连接至电路？',
    answer: ['并联至电路中', '串联至电路中', '正交至电路中', '与电路同相连接'],
  },
  {
    index: '[I]LK1193',
    question: '电流表通常要怎样连接至电路？',
    answer: ['串联至电路中', '并联至电路中', '正交至电路中', '与电路同相连接'],
  },
  {
    index: '[I]LK1194',
    question: '哪一种设备被用来测量电阻？',
    answer: ['欧姆表', '频谱分析仪', '天线分析仪', '示波器'],
  },
  {
    index: '[I]LK1195',
    question: '下列哪一种行为有可能损坏万用表？',
    answer: [
      '在电阻挡试图测量电压',
      '把万用表设在“毫安”挡放置了一夜',
      '在大电压量程下测量一个非常小的电压',
  ...
  {
    index: '[I]LK1196',
    question: '我们经常使用万用表测量以下哪些物理量？',
    answer: ['电压和电阻', '信号的强度和噪音', '阻抗和电抗', '驻波比和射频功率'],
  },
  {
    index: '[I]LK1206',
    question: '下列哪一种方法可以用来定位无线电噪音源或者恶意干扰源？',
    answer: ['无线电测向', '多普勒雷达', '回波定位', '相位锁定'],
  },
  {
    index: '[I]LK1229',
    question: '如何在电网停电的状况下给一个12伏的铅酸蓄电池充电？',
    answer: [
  ...
  {
    index: '[I]LK1231',
    question: '如果铅酸蓄电池的充电和放电进行得过快会怎样？',
    answer: [
  ...
  {
    index: '[I]LK1235',
    question: 'VHF和UHF信号属于下面哪一类辐射？',
    answer: ['非电离辐射', '电离辐射', '阿尔法辐射', '伽玛辐射'],
  },
  {
    index: '[I]LK0996',
    question: '防雷装置的作用是防止雷电危害。传统防雷装置的主要组成部分是：',
    answer: [
      '接闪器（避雷针）、引下线、接地体',
      '天线、限流器、地线',
      '避雷针、高压指示灯、过流保护器',
  ...
  {
    index: '[I]LK0998',
    question: '关于对防雷接地基本要求的正确说法：',
    answer: [
      '要有单独的接地体，接地电阻要小，接闪器到接地体之间的引下线应尽量短而粗',
      '可以利用与埋地金属管线相连的自来水管作为接地体',
      '交流电网的“零线”在配电系统中已经接地，因此可代替防雷接地体及其引下线',
      '接闪器到接地体之间的引下线平时没有电流流过，采用直径0.5毫米的导线为好',
    ],
  },
  {
    index: '[I]LK0999',
    question: '单支避雷针的保护范围大致有多大：',
    answer: [
      '以避雷针为顶点的45度圆锥体以内空间',
      '避雷针周围水平方圆30米内的任何物体',
      '避雷针周围所有比避雷针低的空间',
      '以避雷针为顶点、避雷针高度为半径的半球体以内空间',
    ],
  },
  {
    index: '[I]LK1000',
  ...
  {
    index: '[I]LK1039',
    question: '如遇设备、电线或者电源引起失火，正确的处置为：',
    answer: [
      '立即切断电源，使用二氧化碳灭火器灭火',
      '立即切断电源，使用化学泡沫灭火器灭火',
      '立即切断电源，用水灭火',
  ...
  {
    index: '[I]LK1040',
    question: '必须带电检修由市电供电的无线电设备时，应做到：',
    answer: [
  ...
  {
    index: '[I]LK1225',
    question: '电路中的保险丝起到什么作用？',
    answer: ['过载时切断电路', '防止电源纹波损害电路', '限制电流，防止触电', '以上三项全部正确'],
  },
  {
    index: '[I]LK1226',
    question: '为什么在需要安装5安培保险丝的地方安装一个20安培的保险丝是不可取的？',
    answer: [
      '过大的电流可能导致火灾',
      '电源的纹波会显著增大',
  ...
  {
    index: '[I]LK1228',
    question: '在为同轴电缆馈线安装避雷器时应当注意什么？',
    answer: [
      '将所有避雷器的地线接到同一个金属板上，然后将这个金属板接到室外的接地极',
      '在每一个避雷器的接地线上安装开关，以防止射频过载损伤避雷器',
      '将每一个避雷器单独引出接地线，并且将它们都连接至电台的地线',
      '要在每一个避雷器处两端并联一个开关，以便在使用大功率输出的时候可以将避雷器旁路掉',
    ],
  },
  {
    index: '[I]LK1230',
    question: '常规的12伏酸铅蓄电池通常有什么潜在的危险？',
    answer: [
      '如果通风不良，有爆炸风险的气体会聚集',
      '有高电压，存在触电的风险',
      '它会释放臭氧，进而污染大气层',
  ...
  {
    index: '[I]LK1233',
    question: '设备电源拔掉电源线以后，检修时还有什么安全风险？',
    answer: [
      '充满高电压的电容器可能造成电击',
  ...
  {
    index: '[I]LK1234',
    question: '自制一台由220伏交流供电的设备，推荐采用的安全措施是：',
    answer: [
      '交流电源入口火线端串联安装保险丝',
      '在交流供电入口处并联安装一个交流电压表',
      '在交流供电入口处串联安装一个电感',
  ...
  },
  {
    ...
    answer: [
      '在发信机与天线间串联中心频率为F1的带阻滤波器，在收信机与天线间串接中心频率为F2的带阻滤波器',
      '在发信机与天线间串联中心频率为F1的带通滤波器，在收信机与天线间串接中心频率为F2的带通滤波器',
      '在发信机与天线间串联中心频率为F2的带阻滤波器，在收信机与天线间串接中心频率为F2的带阻滤波器',
      '在发信机与天线间串联中心频率为F1的带阻滤波器，在收信机与天线间串接中心频率为F1的带阻滤波器',
    ],
  },
  {
    index: '[I]LK0575',
  ...
  {
    index: '[I]LK1002',
    question: '我国业余电台应该遵守的关于电磁辐射污染的具体管理规定文件为： ',
    answer: [
      '国家标准GB/T 51391《通信工程建设环境保护技术标准》',
      '《业余电台管理办法》',
      '国际非电离辐射防护委员会《限制时变电场和磁场暴露的导则》',
      '美国FCC《射频电磁场人员暴露准则的测评方法规》',
    ],
  },
  {
    index: '[I]LK1003',
  ...
  },
  {
    ...
    answer: ['30MHz- 3GHz', '3MHz- 30MHz', '300kHz-30MHz', '1200MHz-30GHz'],
  },
  {
    index: '[I]LK1128',
    question: '移动车载台的直流电源负极应当接在哪里？',
    answer: [
      '连接在电池的负极或发动机的接地带',
      '连接在天线座上',
      '可以连接在汽车的任意的金属部分',
  ...
  {
    index: '[I]LK1236',
    question: '为什么电磁辐射防护规定国家标准中的照射限值随着频率的变化而不同？',
    answer: [
      '人体会对某些特定频率的电磁波吸收量更大',
      '较低频率的无线电波不会穿透人体',
      '在自然中高频电磁波不常见',
